...
export function Transaction({ data, onRemove }: Props) {
    return (
        <View style={styles.container}>
            <MaterialIcons name={data.type === TransactionType.INPUT ? "arrow-upward" : "arrow-downward"} size={24} color={data.type === TransactionType.INPUT ? colors.blue[500] : colors.red[400]} />
